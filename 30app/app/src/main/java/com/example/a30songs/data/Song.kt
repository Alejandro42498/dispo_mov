...
val canciones = listOf(
    ...
    Cancion(R.drawable.cerati, R.string.titulo_crimen, R.string.artista_cerati),
    Cancion(R.drawable.beatles, R.string.titulo_let_it_be, R.string.artista_beatles),
    Cancion(R.drawable.queen, R.string.titulo_bohemian, R.string.artista_queen),
    Cancion(R.drawable.chaya, R.string.titulo_un_siglo_sin_ti, R.string.artista_chayanne),
    Cancion(R.drawable.shaki, R.string.titulo_antologia, R.string.artista_shakira),
    Cancion(R.drawable.arjona, R.string.titulo_fuiste_tu, R.string.artista_arjona),
    Cancion(R.drawable.am, R.string.titulo_do_i_wanna_know, R.string.artista_am),
    Cancion(R.drawable.coldplay, R.string.titulo_yellow, R.string.artista_coldplay),
